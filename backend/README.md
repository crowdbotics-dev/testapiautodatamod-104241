...
## Project Structure
    ...
    ├── testapiautodatamod_104241  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_104241`
...
2. Clone this repo and `cd testapiautodatamod_104241`
